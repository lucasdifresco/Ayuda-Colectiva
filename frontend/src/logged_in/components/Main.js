...
function Main(props) {
  ...
  const fetchRandomUsers = useCallback(() => {
    ...
    const userTemplates = [
      {
        name: "Ayuda colectiva",
        surname: "Gomez",
        cuit: "222222222",
        email: "ayudacolectiva@test.com",
        role: "Pendiente",
      },
      {
        name: "Green Peace",
