  ...
  const [state, setState] = React.useState({
    columns: [
      ...
      },
      {
        title: 'Evento',
        field: 'event',
        lookup: { 20: 'La pampa 21, Rosario, Santa Fe', 10: 'Incendios en el Bolson', 30:'Calamuchita, Villa General Belgrano'},
      },
      {
